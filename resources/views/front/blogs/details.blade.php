...
{{--                                <li class="list-inline-item text-color">On {{$blog->created_at->format('D d M, Y')}}</li>--}}
{{--                                <li class="list-inline-item text-color">On {{\Illuminate\Support\Carbon::parse($blog->created_at)->format('D d F Y')}}</li>--}}
