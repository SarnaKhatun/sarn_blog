...
@section('body')
    ...
    <!-- clients -->
    <section class="clients section bg-secondary overlay-dark" style="background-image: url({{asset('/')}}front/images/background/clients-bg.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                        ...
                        <div class="col-6">
                            <ul class="pl-0">
                                <li class="text-center mb-3">
                                    <img src="{{asset('/')}}front/images/client-logo/client-logo-1-white.png" alt="client-logo">
                                </li>
                                <li class="text-center mb-3">
                                    <img src="{{asset('/')}}front/images/client-logo/client-logo-3-white.png" alt="client-logo">
                                </li>
                                <li class="text-center mb-3">
                                    <img src="{{asset('/')}}front/images/client-logo/client-logo-5-white.png" alt="client-logo">
                                </li>
                            </ul>
                        </div>
                        <div class="col-6">
                            <ul>
                                <li class="text-center mb-3">
                                    <img src="{{asset('/')}}front/images/client-logo/client-logo-2-white.png" alt="client-logo">
                                </li>
                                <li class="text-center mb-3">
                                    <img src="{{asset('/')}}front/images/client-logo/client-logo-4-white.png" alt="client-logo">
                                </li>
                                <li class="text-center mb-3">
                                    <img src="{{asset('/')}}front/images/client-logo/client-logo-1-white.png" alt="client-logo">
                                </li>
